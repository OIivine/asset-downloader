	...
	<body>
		...
		<section class="content centered">
			<div class="center">
				...
				<a draggable="true" class="button" href="javascript:(function(){location.href='http://roblox-asset.comoj.com/'+location.href.match(/(?:catalog|library|games)\/(\d+)/i)[1]})()" onclick="return false">Download Roblox Asset</a>
